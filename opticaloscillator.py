...
class Oscillator(object):
    ...
    def __init__(self,a1,A1, g, l0):
        ...
        self._w = np.linspace(0.005, 0.1, 159)
        self.l0 = l0
...
class MixingOscillators(object):
    ...
    def mix(self):
        """
         create a grid to map on 2-D apply basic averaging of oscillators
...
if __name__ == "__main__":
    ...
    # example of a an a single oscillator plotting absolute, real and complex components
